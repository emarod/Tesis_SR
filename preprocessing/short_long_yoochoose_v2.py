...
generate_final_sessions(short_info_tra, short_info_tes, "yoochoose_short", split=64)
generate_final_sessions(long_info_tra, long_info_tes, "yoochoose_long", split=64)
